...
RELATION_REGISTRY: dict[str, RelationSpec] = {
    ...
    "on_line": RelationSpec("on_line", verify="supported", auto_fix_policy="safe", aliases=("point_on_line",)),
    "line_through_points": RelationSpec("line_through_points", verify="supported", auto_fix_policy="none"),
...
RELATION_CONTRACTS_V3: dict[str, RelationContractV3] = {
    ...
    "line_through_points": RelationContractV3((("point", 2), ("linear", 1))),
