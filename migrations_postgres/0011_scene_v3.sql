ALTER TABLE render_jobs ADD COLUMN IF NOT EXISTS migration_report_json TEXT;
ALTER TABLE scene_revisions ADD COLUMN IF NOT EXISTS schema_version TEXT NOT NULL DEFAULT '2.0';
ALTER TABLE scene_revisions ADD COLUMN IF NOT EXISTS migration_report_json TEXT;
ALTER TABLE scene_revisions ADD COLUMN IF NOT EXISTS command_log_json TEXT NOT NULL DEFAULT '[]';

CREATE TABLE IF NOT EXISTS scene_workspaces (
  scene_id TEXT PRIMARY KEY,
  user_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  history_item_id TEXT REFERENCES history_items(id) ON DELETE SET NULL,
